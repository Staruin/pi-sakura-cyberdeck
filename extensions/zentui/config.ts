...
export const defaultConfig: PolishedTuiConfig = {
	...
	colors: {
		cwd: "bold #B79CF0",
		gitBranch: "bold #9F86E8",
		gitStatus: "bold #E8A87C",
		contextNormal: "#94A9F0",
		contextWarning: "bold #E9CF7E",
		contextError: "bold #E8637F",
		tokens: "#A79BB8",
		cost: "#E8A87C",
		separator: "#6E6778",
		runtimePrefix: "#94A9F0",
		extensionStatus: "#D8C2F5",
		sessionDuration: "#E9CF7E",
		packageVersion: "#E8A87C",
		gitCommit: "#8FE0BC",
		gitMetricsAdded: "#8FE0BC",
		gitMetricsDeleted: "#E8637F",
		username: "#E9CF7E",
		time: "#E9CF7E",
		os: "#F3EFF8",
		editorAccent: "bold #B79CF0",
		editorPrompt: "bold #B79CF0",
		editorBorder: "sakura-macaron-gradient",
		editorModel: "bold #B79CF0",
		editorProvider: "#A8A6DC",
		editorThinking: "#9F86E8",
		editorThinkingMinimal: "#6E6778",
		editorThinkingLow: "#94A9F0",
		editorThinkingMedium: "#D8C2F5",
		editorThinkingHigh: "bold #B79CF0",
		editorThinkingXhigh: "bold #9F86E8",
	},
	colorSources: {
		starship: "terminal",
		editor: "terminal",
